    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialist', models.CharField(choices=[('Filler', 'Filler'), ('Botox', 'Botox'), ('Nakh', 'Nakh'), ('Javansazi', 'Javansazi'), ('Laghari', 'Laghari'), ('Lazer', 'Lazer'), ('Bardasht Ghabghab', 'Bardasht Ghabghab'), ('Bardasht Khal', 'Bardasht Khal'), ('Subsision', 'Subsision'), ('Termia', 'Termia'), ('Tarmim', 'Tarmim'), ('Moshavere', 'Moshavere'), ('Other', 'Other')], default='Other', max_length=50)),
